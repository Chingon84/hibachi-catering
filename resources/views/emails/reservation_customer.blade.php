...
<html lang="en">
  ...
  <body style="margin:0;padding:0;background:#f3f4f6;">
    @php
      ...
      try {
          $date = $r?->date ? \Carbon\Carbon::parse($r->date)->format('m/d/Y') : $missing;
      } catch (\Throwable $e) {
    ...
    <div style="display:none;max-height:0;overflow:hidden;opacity:0;color:transparent;">
      Thank you for your reservation. We received your payment and confirmed your event.
    </div>
          ...
          <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="640" style="width:100%;max-width:640px;border-collapse:separate;border-spacing:0;">
            <tr>
              <td style="background:#101827;border-radius:18px 18px 0 0;padding:22px 24px 20px;font-family:{{ $font }};color:#ffffff;">
                      ...
                      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          ...
                          <td valign="middle" style="padding:0;">
                            ...
                            <div style="font-size:12px;line-height:1.4;color:#cbd5e1;margin-top:2px;">Reservation Confirmation · Invoice #{{ $invoiceNo }}</div>
                          </td>
                        </tr>
                      </table>
                    </td>
                    <td align="right" valign="middle" style="padding:0;">
                      <span style="display:inline-block;border:1px solid rgba(255,255,255,.18);border-radius:999px;padding:7px 11px;color:#e5e7eb;font-size:11px;line-height:1;font-weight:800;text-transform:uppercase;letter-spacing:.08em;">Payment Confirmed</span>
                    </td>
                  </tr>
                </table>
                ...
                <h1 style="margin:14px 0 7px;font-size:28px;line-height:1.15;font-weight:850;color:#ffffff;">Thank you for your reservation!</h1>
                <div style="font-size:14px;line-height:1.6;color:#d1d5db;">
                  We received your payment and confirmed your event.<br>
                  Reservation Code: <strong style="color:#ffffff;">{{ $reservationCode }}</strong>
                </div>
              </td>
            </tr>
            ...
            <tr>
              <td style="background:#ffffff;border-left:1px solid #e5e7eb;border-right:1px solid #e5e7eb;padding:22px 24px 8px;font-family:{{ $font }};color:#111827;">
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #e5e7eb;border-radius:14px;border-collapse:separate;border-spacing:0;overflow:hidden;margin:0 0 16px;">
                  <tr>
                    <td colspan="2" style="background:#f8fafc;padding:13px 16px;border-bottom:1px solid #e5e7eb;">
                      <div style="font-size:12px;font-weight:900;color:#111827;text-transform:uppercase;letter-spacing:.08em;">Client &amp; Event</div>
                    </td>
                  </tr>
                  @foreach([
                    ...
                    'Phone' => $value($r?->phone),
                    'Time' => $time,
                    'Address of the event' => $addressLine,
                    'Color setup' => $value($r?->setup_color),
                    'Special request / Notes' => $value($r?->notes),
                  ] as $label => $detail)
                    <tr>
                      <td width="38%" valign="top" style="padding:11px 16px;border-bottom:1px solid #f1f5f9;color:#64748b;font-size:12px;font-weight:800;text-transform:uppercase;letter-spacing:.05em;">{{ $label }}</td>
                      <td width="62%" valign="top" style="padding:11px 16px;border-bottom:1px solid #f1f5f9;color:#111827;font-size:14px;line-height:1.5;font-weight:600;">{{ $detail }}</td>
                    </tr>
                  @endforeach
                </table>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #e5e7eb;border-radius:14px;border-collapse:separate;border-spacing:0;overflow:hidden;margin:0 0 16px;">
                  ...
                  <tr>
                    <td style="padding:10px 16px;border-bottom:1px solid #f1f5f9;color:#166534;font-size:14px;font-weight:800;">Total paid</td>
                  ...
                  <tr>
                    <td style="padding:12px 16px;color:#111827;font-size:15px;font-weight:900;">Balance</td>
                  ...
                  <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="border:1px solid #e5e7eb;border-radius:14px;border-collapse:separate;border-spacing:0;overflow:hidden;margin:0 0 16px;">
                    <tr>
                      <td colspan="4" style="background:#f8fafc;padding:13px 16px;border-bottom:1px solid #e5e7eb;">
                        <div style="font-size:12px;font-weight:900;color:#111827;text-transform:uppercase;letter-spacing:.08em;">Menu</div>
                      </td>
                    </tr>
                    <tr>
                ...
                <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%" style="background:#f8fafc;border:1px solid #e5e7eb;border-radius:14px;border-collapse:separate;border-spacing:0;margin:0 0 18px;">
                  <tr>
                    <td style="padding:15px 16px;color:#374151;font-size:13px;line-height:1.6;">
                      We’ll reach out a few days before your event to confirm all details. If you need anything, reply to this email or call 951-326-9602.
                      <br>
                      <span style="color:#64748b;font-size:12px;">An invoice is attached for your records.</span>
                    </td>
                  </tr>
                </table>
              </td>
