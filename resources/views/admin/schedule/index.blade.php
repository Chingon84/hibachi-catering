...
@push('styles')
<style>
  /* Page-specific schedule dashboard. Core chrome from app.css. */
  html,body{max-width:100%;overflow-x:hidden}
  .wrap{width:100%;max-width:none;margin:0;padding:20px 24px;overflow-x:hidden}
  .sched-stack{display:grid;gap:10px;min-width:0}
  .head{display:flex;align-items:center;justify-content:space-between;gap:12px;flex-wrap:wrap}
  .sched-title{margin:0;font-size:22px;line-height:1.05}
