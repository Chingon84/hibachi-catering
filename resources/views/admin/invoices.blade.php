...
@push('styles')
<style>
  /* Page-specific invoices list (Stripe-style). Core chrome from app.css. */
  ...
  .global-search svg{position:absolute;left:12px;top:50%;transform:translateY(-50%);width:16px;height:16px;color:var(--muted)}
  .global-search .input{padding-left:38px;background:var(--surface-2);border-color:#eef2f7}
  ...
  .create-btn{display:inline-flex;align-items:center;gap:8px;background:var(--brand);color:#fff;text-decoration:none;border:0;border-radius:8px;padding:9px 14px;font-weight:800;line-height:1;box-shadow:0 8px 18px rgba(178,30,39,.16)}
  ...
  .tab-count{color:var(--muted);font-size:12px;font-weight:800}
  ...
  .status-badge{display:inline-flex;align-items:center;padding:3px 8px;border-radius:6px;border:1px solid #dbe2ea;background:var(--surface-2);color:#475569;font-size:12px;font-weight:750}
  .status-badge.draft,.status-badge.void{background:var(--surface-2);color:#475569;border-color:#dbe2ea}
  ...
  .inv-actions{display:flex;justify-content:flex-end;gap:6px;align-items:center}
  ...
  .action-link:hover{background:var(--surface-2);border-color:#cbd5e1}
  .action-link.primary{color:var(--brand);background:var(--brand-soft);border-color:#fecdd3}
  ...
  @media (max-width:640px){.tabs{grid-template-columns:1fr}.topbar,.title-row{align-items:flex-start;flex-direction:column}.header-actions{width:100%;justify-content:flex-start}}
</style>
@endpush
